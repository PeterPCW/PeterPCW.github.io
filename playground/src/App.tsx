...
function App() {
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="min-h-[80vh] flex items-center justify-center text-center px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {guides.map((guide) => (
              <a
                key={guide.name}
                href={guide.url}
                className="bg-surface border border-border rounded-xl p-6 text-center hover:border-primary transition"
              >
                ...
                <p className="text-primary font-semibold">{guide.price}</p>
              </a>
            ))}
          </div>
        </div>
